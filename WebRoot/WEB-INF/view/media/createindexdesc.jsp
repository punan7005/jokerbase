...
<div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content" id="tab2">
          <form name="createmeida" id="createmedia" action="${ctx }/media/uploaddesc.shtml" method="post">
            <fieldset>
            <!-- 设置类”列左”或“右列”字段划分形成列 -->
            <p>
             <label>分类列表</label>
            ...
            <textarea cols="79" rows="15" id="mediaDesc" name="mediaDesc" >无</textarea>
            </p>
            <p>
            <p>
	...
	$(function(){
		$('#imgFile').uploadify({
			...
			uploader : '/media/uploaddesc.shtml',
