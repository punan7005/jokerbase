      ...
      <div class="content-box-content">
        <div class="tab-content" id="tab2">
          <form name="createchannel" id="createchannel" action="${ctx }/channel/createchannel.shtml" method="post">
            ...
            <p>
            <label>用户密码</label>
            <input class="text-input small-input" type="password" id="userPassword" name="userPassword" />
            <br /></p>
            <p>
            <label>用户邮箱</label>
            <input class="text-input small-input" type="text" id="userEmail" name="userEmail" />
            <br /></p>
              <!-- 
            <p>
              <label>介质形式输入</label>
...
function submituser(){
	...
	$("#right").html("loading...");
	$("#right").load(
	"${ctx }/user/createuser.shtml", //请求路径
	{
		"userName":userName,
		"userEmail":userEmail,
