...
<div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content" id="tab2">
          <form name="createcomment" id="createcomment" action="${ctx }/content/update.shtml" method="post">
            ...
            <p>
             ...
             <label>分类列表</label>
               ...
               <c:forEach var="channel" items="${channels}">
                      ...
                      <option value="${channel.channelId }" <c:if test="${content.contentChannelId == channel.channelId }" > selected="selected" </c:if>>${channel.channelName}</option>
               </c:forEach>
               </select>
            </p>
            <p>
